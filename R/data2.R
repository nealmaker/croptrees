...
# MORE FOCUSSED VERSION OF DATA W/ FEWER SPP & SITES AND 1" DBH STEPS AND ONLY ST OR VENEER
################################################################################
...
# species of interest chosen from forestmaker species: hard
# maple, paper birch, red maple, red oak, white oak, white
# pine, yellow birch
species <- unique(forestgrower::params_default$prices$spp)[
  c(23, 52, 54, 55, 68, 73, 75)]
